...
var source = (() => {
  ...
  // src/NatoMangaCOM/main.ts
  var main_exports = {};
  __export(main_exports, {
    NatoMangaCOM: () => NatoMangaCOM
  });
  init_buffer();
  ...
  // src/NatoMangaCOM/main.ts
  var DOMAIN = "https://www.natomanga.com";
  var NatoMangaCOMExtension = class extends MangaboxGeneric {
    constructor() {
      super({
        domain: DOMAIN,
  ...
  var NatoMangaCOM = new NatoMangaCOMExtension();
