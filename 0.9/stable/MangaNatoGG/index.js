...
var source = (() => {
  ...
  // src/MangaNatoGG/main.ts
  var main_exports = {};
  __export(main_exports, {
    MangaNatoGG: () => MangaNatoGG
  });
  init_buffer();
  ...
  // src/MangaNatoGG/main.ts
  var DOMAIN = "https://www.manganato.gg";
  var MangaNatoGGExtension = class extends MangaboxGeneric {
    constructor() {
      super({
        domain: DOMAIN,
  ...
  var MangaNatoGG = new MangaNatoGGExtension();
