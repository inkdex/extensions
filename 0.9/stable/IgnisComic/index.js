...
var source = (() => {
  ...
  // src/IgnisComic/main.ts
  var DOMAIN_NAME = "https://manhuaga.com/";
  var IgnisComicExt = class extends MangaStreamGeneric {
    domain = DOMAIN_NAME;
  ...
  var IgnisComic = new IgnisComicExt();
