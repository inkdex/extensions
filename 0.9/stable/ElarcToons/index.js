...
var source = (() => {
  ...
  // src/ElarcToons/main.ts
  var main_exports = {};
  __export(main_exports, {
    ElarcToons: () => ElarcToons
  });
  init_buffer();
  ...
  // src/ElarcToons/main.ts
  var DOMAIN_NAME = "https://elarctoons.biz/";
  var ElarcToonsExtension = class extends MangaStreamGeneric {
    domain = DOMAIN_NAME;
    name = pbconfig_default.name;
    contentRating = pbconfig_default.contentRating;
    directoryPath = "library";
  };
  var ElarcToons = new ElarcToonsExtension();
