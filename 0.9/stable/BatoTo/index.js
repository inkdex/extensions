...
var source = (() => {
  ...
  // src/BatoTo/SettingsForm.ts
  init_buffer();
  var import_types2 = __toESM(require_lib(), 1);

  // src/BatoTo/helper.ts
  init_buffer();
  var BTTLanguagesClass = class {
    Languages = [
      // Existing languages
      { name: "\u0627\u064E\u0644\u0652\u0639\u064E\u0631\u064E\u0628\u0650\u064A\u064E\u0651\u0629\u064F", langCode: "ar", flagCode: "\u{1F1E6}\u{1F1EA}" },
      { name: "\u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438", langCode: "bg", flagCode: "\u{1F1E7}\u{1F1EC}" },
      { name: "\u09AC\u09BE\u0982\u09B2\u09BE", langCode: "bn", flagCode: "\u{1F1E7}\u{1F1E9}" },
      { name: "Catal\xE0", langCode: "ca", flagCode: "\u{1F1EA}\u{1F1F8}" },
      { name: "\u010Ce\u0161tina", langCode: "cs", flagCode: "\u{1F1E8}\u{1F1FF}" },
      { name: "Dansk", langCode: "da", flagCode: "\u{1F1E9}\u{1F1F0}" },
      { name: "Deutsch", langCode: "de", flagCode: "\u{1F1E9}\u{1F1EA}" },
      { name: "English", langCode: "en", flagCode: "\u{1F1EC}\u{1F1E7}", default: true },
      { name: "Espa\xF1ol", langCode: "es", flagCode: "\u{1F1EA}\u{1F1F8}" },
      { name: "Espa\xF1ol (Latinoam\xE9rica)", langCode: "es-la", flagCode: "\u{1F1EA}\u{1F1F8}" },
      { name: "\u0641\u0627\u0631\u0633\u06CC", langCode: "fa", flagCode: "\u{1F1EE}\u{1F1F7}" },
      { name: "Suomi", langCode: "fi", flagCode: "\u{1F1EB}\u{1F1EE}" },
      { name: "Fran\xE7ais", langCode: "fr", flagCode: "\u{1F1EB}\u{1F1F7}" },
      { name: "\u05E2\u05B4\u05D1\u05B0\u05E8\u05B4\u05D9\u05EA", langCode: "he", flagCode: "\u{1F1EE}\u{1F1F1}" },
      { name: "\u0939\u093F\u0928\u094D\u0926\u0940", langCode: "hi", flagCode: "\u{1F1EE}\u{1F1F3}" },
      { name: "Magyar", langCode: "hu", flagCode: "\u{1F1ED}\u{1F1FA}" },
      { name: "Indonesia", langCode: "id", flagCode: "\u{1F1EE}\u{1F1E9}" },
      { name: "Italiano", langCode: "it", flagCode: "\u{1F1EE}\u{1F1F9}" },
      { name: "\u65E5\u672C\u8A9E", langCode: "ja", flagCode: "\u{1F1EF}\u{1F1F5}" },
      { name: "\uD55C\uAD6D\uC5B4", langCode: "ko", flagCode: "\u{1F1F0}\u{1F1F7}" },
      { name: "Lietuvi\u0173", langCode: "lt", flagCode: "\u{1F1F1}\u{1F1F9}" },
      { name: "\u043C\u043E\u043D\u0433\u043E\u043B", langCode: "mn", flagCode: "\u{1F1F2}\u{1F1F3}" },
      { name: "Melayu", langCode: "ms", flagCode: "\u{1F1F2}\u{1F1FE}" },
      { name: "\u1019\u103C\u1014\u103A\u1019\u102C\u1018\u102C\u101E\u102C", langCode: "my", flagCode: "\u{1F1F2}\u{1F1F2}" },
      { name: "Nederlands", langCode: "nl", flagCode: "\u{1F1F3}\u{1F1F1}" },
      { name: "Norsk", langCode: "no", flagCode: "\u{1F1F3}\u{1F1F4}" },
      { name: "Polski", langCode: "pl", flagCode: "\u{1F1F5}\u{1F1F1}" },
      { name: "Portugu\xEAs", langCode: "pt", flagCode: "\u{1F1F5}\u{1F1F9}" },
      { name: "Portugu\xEAs (Brasil)", langCode: "pt-br", flagCode: "\u{1F1E7}\u{1F1F7}" },
      { name: "Rom\xE2n\u0103", langCode: "ro", flagCode: "\u{1F1F7}\u{1F1F4}" },
      { name: "P\u0443\u0441\u0441\u043A\u0438\u0439", langCode: "ru", flagCode: "\u{1F1F7}\u{1F1FA}" },
      { name: "C\u0440\u043F\u0441\u043A\u0438", langCode: "sr", flagCode: "\u{1F1F7}\u{1F1F8}" },
      { name: "Svenska", langCode: "sv", flagCode: "\u{1F1F8}\u{1F1EA}" },
      { name: "\u0E44\u0E17\u0E22", langCode: "th", flagCode: "\u{1F1F9}\u{1F1ED}" },
      { name: "Filipino", langCode: "tl", flagCode: "\u{1F1F5}\u{1F1ED}" },
      { name: "T\xFCrk\xE7e", langCode: "tr", flagCode: "\u{1F1F9}\u{1F1F7}" },
      { name: "Y\u043A\u0440\u0430\u0457\u0301\u043D\u0441\u044C\u043A\u0430", langCode: "uk", flagCode: "\u{1F1FA}\u{1F1E6}" },
      { name: "Ti\u1EBFng Vi\u1EC7t", langCode: "vi", flagCode: "\u{1F1FB}\u{1F1F3}" },
      { name: "\u4E2D\u6587 (\u7B80\u5316\u5B57)", langCode: "zh", flagCode: "\u{1F1E8}\u{1F1F3}" },
      { name: "\u4E2D\u6587 (\u7E41\u9AD4\u5B57)", langCode: "zh-hk", flagCode: "\u{1F1ED}\u{1F1F0}" },
      // New languages from the HTML
      { name: "Afrikaans", langCode: "af", flagCode: "\u{1F1FF}\u{1F1E6}" },
      { name: "Albanian", langCode: "sq", flagCode: "\u{1F1E6}\u{1F1F1}" },
      { name: "Amharic", langCode: "am", flagCode: "\u{1F1EA}\u{1F1F9}" },
      { name: "Armenian", langCode: "hy", flagCode: "\u{1F1E6}\u{1F1F2}" },
      { name: "Azerbaijani", langCode: "az", flagCode: "\u{1F1E6}\u{1F1FF}" },
      { name: "Belarusian", langCode: "be", flagCode: "\u{1F1E7}\u{1F1FE}" },
      { name: "Bosnian", langCode: "bs", flagCode: "\u{1F1E7}\u{1F1E6}" },
      { name: "Burmese", langCode: "my", flagCode: "\u{1F1F2}\u{1F1F2}" },
      { name: "Cambodian", langCode: "km", flagCode: "\u{1F1F0}\u{1F1ED}" },
      { name: "Cebuano", langCode: "ceb", flagCode: "\u{1F1F5}\u{1F1ED}" },
      { name: "Chinese (\u7E41)", langCode: "zh-hant", flagCode: "\u{1F1F9}\u{1F1FC}" },
      { name: "Chinese (\u7CB5)", langCode: "yue", flagCode: "\u{1F1ED}\u{1F1F0}" },
      { name: "Croatian", langCode: "hr", flagCode: "\u{1F1ED}\u{1F1F7}" },
      { name: "Estonian", langCode: "et", flagCode: "\u{1F1EA}\u{1F1EA}" },
      { name: "Faroese", langCode: "fo", flagCode: "\u{1F1EB}\u{1F1F4}" },
      { name: "Georgian", langCode: "ka", flagCode: "\u{1F1EC}\u{1F1EA}" },
      { name: "Greek", langCode: "el", flagCode: "\u{1F1EC}\u{1F1F7}" },
      { name: "Guarani", langCode: "gn", flagCode: "\u{1F1F5}\u{1F1FE}" },
      { name: "Gujarati", langCode: "gu", flagCode: "\u{1F1EE}\u{1F1F3}" },
      { name: "Haitian Creole", langCode: "ht", flagCode: "\u{1F1ED}\u{1F1F9}" },
      { name: "Hausa", langCode: "ha", flagCode: "\u{1F1F3}\u{1F1EA}" },
      { name: "Icelandic", langCode: "is", flagCode: "\u{1F1EE}\u{1F1F8}" },
      { name: "Igbo", langCode: "ig", flagCode: "\u{1F1F3}\u{1F1EC}" },
      { name: "Irish", langCode: "ga", flagCode: "\u{1F1EE}\u{1F1F8}" },
      { name: "Javanese", langCode: "jv", flagCode: "\u{1F1EE}\u{1F1E9}" },
      { name: "Kannada", langCode: "kn", flagCode: "\u{1F1EE}\u{1F1F3}" },
      { name: "Kazakh", langCode: "kk", flagCode: "\u{1F1F0}\u{1F1FF}" },
      { name: "Kurdish", langCode: "ku", flagCode: "\u{1F1EE}\u{1F1F6}" },
      { name: "Kyrgyz", langCode: "ky", flagCode: "\u{1F1F0}\u{1F1EC}" },
      { name: "Laothian", langCode: "lo", flagCode: "\u{1F1F1}\u{1F1E6}" },
      { name: "Latvian", langCode: "lv", flagCode: "\u{1F1F1}\u{1F1FB}" },
      { name: "Luxembourgish", langCode: "lb", flagCode: "\u{1F1F1}\u{1F1FA}" },
      { name: "Macedonian", langCode: "mk", flagCode: "\u{1F1F2}\u{1F1F0}" },
      { name: "Malagasy", langCode: "mg", flagCode: "\u{1F1F2}\u{1F1EC}" },
      { name: "Malayalam", langCode: "ml", flagCode: "\u{1F1EE}\u{1F1F3}" },
      { name: "Maltese", langCode: "mt", flagCode: "\u{1F1F2}\u{1F1F9}" },
      { name: "Maori", langCode: "mi", flagCode: "\u{1F1F3}\u{1F1FF}" },
      { name: "Marathi", langCode: "mr", flagCode: "\u{1F1EE}\u{1F1F3}" },
      { name: "Moldavian", langCode: "mo", flagCode: "\u{1F1F2}\u{1F1E9}" },
      { name: "Nepali", langCode: "ne", flagCode: "\u{1F1F3}\u{1F1F5}" },
      { name: "Nyanja", langCode: "ny", flagCode: "\u{1F1F2}\u{1F1FC}" },
      { name: "Pashto", langCode: "ps", flagCode: "\u{1F1E6}\u{1F1EB}" },
      { name: "Persian", langCode: "fa", flagCode: "\u{1F1EE}\u{1F1F7}" },
      { name: "Portuguese (BR)", langCode: "pt-br", flagCode: "\u{1F1E7}\u{1F1F7}" },
      { name: "Romansh", langCode: "rm", flagCode: "\u{1F1E8}\u{1F1ED}" },
      { name: "Samoan", langCode: "sm", flagCode: "\u{1F1FC}\u{1F1F8}" },
      { name: "Serbo-Croatian", langCode: "sh", flagCode: "\u{1F1F7}\u{1F1F8}" },
      { name: "Sesotho", langCode: "st", flagCode: "\u{1F1F1}\u{1F1F8}" },
      { name: "Shona", langCode: "sn", flagCode: "\u{1F1FF}\u{1F1FC}" },
      { name: "Sindhi", langCode: "sd", flagCode: "\u{1F1F5}\u{1F1F0}" },
      { name: "Sinhalese", langCode: "si", flagCode: "\u{1F1F1}\u{1F1F0}" },
      { name: "Slovak", langCode: "sk", flagCode: "\u{1F1F8}\u{1F1F0}" },
      { name: "Slovenian", langCode: "sl", flagCode: "\u{1F1F8}\u{1F1EE}" },
      { name: "Somali", langCode: "so", flagCode: "\u{1F1F8}\u{1F1F4}" },
      { name: "Spanish (LA)", langCode: "es-la", flagCode: "\u{1F1F2}\u{1F1FD}" },
      { name: "Swahili", langCode: "sw", flagCode: "\u{1F1F0}\u{1F1EA}" },
      { name: "Tajik", langCode: "tg", flagCode: "\u{1F1F9}\u{1F1EF}" },
      { name: "Tamil", langCode: "ta", flagCode: "\u{1F1F1}\u{1F1F0}" },
      { name: "Telugu", langCode: "te", flagCode: "\u{1F1EE}\u{1F1F3}" },
      { name: "Tigrinya", langCode: "ti", flagCode: "\u{1F1EA}\u{1F1F7}" },
      { name: "Tonga", langCode: "to", flagCode: "\u{1F1F9}\u{1F1F4}" },
      { name: "Turkmen", langCode: "tk", flagCode: "\u{1F1F9}\u{1F1F2}" },
      { name: "Urdu", langCode: "ur", flagCode: "\u{1F1F5}\u{1F1F0}" },
      { name: "Uzbek", langCode: "uz", flagCode: "\u{1F1FA}\u{1F1FF}" },
      { name: "Yoruba", langCode: "yo", flagCode: "\u{1F1F3}\u{1F1EC}" },
      { name: "Zulu", langCode: "zu", flagCode: "\u{1F1FF}\u{1F1E6}" },
      { name: "Other", langCode: "other", flagCode: "\u{1F3F3}\uFE0F\u200D\u{1F308}" }
    ];
    constructor() {
  ...
  var BTTLanguages = new BTTLanguagesClass();

  // src/BatoTo/SettingsForm.ts
  function getLanguages() {
    return Application.getState("languages") ?? BTTLanguages.getDefault();
  }
  var BatoToSettingsForm = class extends import_types2.Form {
    // State management for the languages field
    languagesState = new State3(
      this,
      "languages",
      getLanguages()
    );
    ...
    getSections() {
      return [
        this.createLanguageSettingsSection()
        // Only language-related section
      ];
    }
    // Create the language settings section
    createLanguageSettingsSection() {
      return (0, import_types2.Section)("languageSettings", [
        (0, import_types2.SelectRow)("languages", {
          title: "Languages",
          value: this.languagesState.value,
          minItemCount: 1,
          maxItemCount: 100,
          options: BTTLanguages.getlangCodeList().map((x) => ({
            id: x,
  ...
  var BatoToExtension = class {
    ...
    async getPopularUpdates(metadata) {
      const items = [];
      ...
      $2("div.home-popular > div.col.item").each((_, element) => {
    ...
    async getLatestReleases(section, metadata) {
      const page = metadata?.page ?? 1;
      const items = [];
      const collectedIds = metadata?.collectedIds ?? [];
      const languages = getLanguages();
      const request = {
        url: new URLBuilder(DOMAIN_NAME).addPath("latest").addQuery("langs", languages.join(",")).build(),
        method: "GET"
      };
      const $2 = await this.fetchCheerio(request);
      $2("div#series-list > div.col.item").each((_, element) => {
        const unit = $2(element);
      ...
      const loadMoreButton = $2("div.load-more button.btn-warning");
      let nextOffset;
      ...
      return {
        items,
        metadata: nextOffset ? { page: nextOffset, collectedIds } : void 0
      };
    }
    // Populates the browse sections
    async getBrowseSections(section, metadata) {
      const page = metadata?.page ?? 1;
      const items = [];
      const collectedIds = metadata?.collectedIds ?? [];
      const languages = getLanguages();
      const request = {
        url: new URLBuilder(DOMAIN_NAME).addPath("browse").addQuery("langs", languages.join(",")).addQuery("sort", "views_m.za").addQuery("page", page.toString()).build(),
        method: "GET"
      };
      const $2 = await this.fetchCheerio(request);
      $2("div#series-list > div.col.item").each((_, element) => {
      ...
      const paginationContainer = $2("ul.pagination");
      let nextPage;
      if (paginationContainer.length > 0) {
        const nextPageItem = paginationContainer.find("li.page-item > a.page-link span").filter((_, el) => $2(el).text().trim() === "\xBB").parent();
    ...
    async getSearchResults(query, metadata) {
      ...
      if (genresFilter) {
        const genresInclusionMap = genresFilter.value;
      ...
      $2(".grid.grid-cols-1.gap-5.border-t.border-t-base-200.pt-5 > div").each(
        (_, element) => {
          const unit = $2(element);
      ...
      $2(".flex.items-center.flex-wrap.space-x-1.my-10.justify-center a").each(
        (_, element) => {
          const pageNumber = parseInt($2(element).text().trim(), 10);
    ...
    async getMangaDetails(mangaId) {
      ...
      const $2 = await this.fetchCheerio(request);
      let title = $2("h3.text-lg.md\\:text-2xl.font-bold").text().trim();
      if (title.length % 2 === 0) {
      ...
      const altNames = [];
      $2(".mt-1.text-xs.md\\:text-base.opacity-80").each((_, element) => {
        const altName = $2(element).text().trim();
        if (altName) altNames.push(altName);
      });
      const image = $2(".w-24.md\\:w-52.flex-none.justify-start.items-start img").attr(
        "data-src"
      ) || $2(".w-24.md\\:w-52.flex-none.justify-start.items-start img").attr(
        "src"
      ) || "";
      const validImage = image.trim();
      const description = $2(".prose.lg\\:prose-lg.limit-html .limit-html-p").text().trim();
      let status = "UNKNOWN";
      const statusText = $2("span.font-bold.uppercase.text-success").text().trim().toLowerCase();
      ...
      const authors = [];
      $2(".mt-2.text-sm.md\\:text-base.opacity-80 a").each((_, element) => {
        authors.push($2(element).text().trim());
      });
      const artists = [];
      $2(".mt-2.text-sm.md\\:text-base.opacity-80 a").each((_, element) => {
        artists.push($2(element).text().trim());
      });
      const genres2 = [];
      $2(
        ...
        if (genre && !genre.includes(",") && !genres2.includes(genre)) {
          genres2.push(genre);
        }
      });
      console.log(`

Here are the genres ${genres2.join(", ")}
...
`);
      ...
      $2(
        ...
        const tag = $2(element).text().trim().replace(/^#/, "");
      ...
      let contentRating = import_types3.ContentRating.EVERYONE;
      const matureGenres = [
        "Adult",
        "Ecchi",
        "Erotica",
      ...
      console.log(
        `mangaID: ${mangaId}, primaryTitle: ${title}, altNames: ${altNames.join(", ")}, thumbnailUrl: ${validImage}, synopsis: ${description}, contentRating: ${import_types3.ContentRating.MATURE}, status: ${status}, tagGroups: ${JSON.stringify(tagSections)}, authors: ${authors.join(", ")}, artists: ${artists.join(", ")}, artworkUrls: ${validImage}`
      );
      return {
        mangaId,
        mangaInfo: {
...
`);
      const $2 = await this.fetchCheerio(request);
      const chapters = [];
      $2(".scrollable-panel div.px-2.py-2").each((_, element) => {
        const row = $2(element);
...
`
    ...
    async getChapterDetails(chapter) {
      console.log(
        "The chapter id is : " + chapter.chapterId + " and the manga id is : " + chapter.sourceManga.mangaId
      );
      const request = {
        url: new URLBuilder(DOMAIN_NAME).addPath("title").addPath(chapter.sourceManga.mangaId).addPath(chapter.chapterId).build(),
        method: "GET"
      };
      console.log(
        `
...
`
      ...
      try {
        const $2 = await this.fetchCheerio(request);
        const pages = [];
        const imageIsland = $2('astro-island[component-url*="ImageList"]');
    ...
    checkCloudflareStatus(status) {
      if (status === 503 || status === 403) {
        throw new import_types3.CloudflareError({ url: DOMAIN_NAME, method: "GET" });
      }
    }
  };
