...
var source = (() => {
  ...
  // src/CypherScans/main.ts
  var DOMAIN_NAME = "https://cypheroscans.xyz/";
  var CypherScansExtension = class extends MangaStreamGeneric {
    domain = DOMAIN_NAME;
    name = pbconfig_default.name;
    contentRating = pbconfig_default.contentRating;
  };
  var CypherScans = new CypherScansExtension();
