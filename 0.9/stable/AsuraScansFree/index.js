...
var source = (() => {
  ...
  // src/AsuraScansFree/pbconfig.ts
  init_buffer();
  ...
  // src/AsuraScansFree/main.ts
  var DOMAIN_NAME = "https://asurascansfree.com";
  var AsuraScansFreeExtension = class extends MangaStreamGeneric {
    domain = DOMAIN_NAME;
    ...
    configureSections() {
      ...
      this.latestUpdatesSection.subtitleSelectorFunc = ($2, element) => $2(".fivchap", element).first().text().trim();
    }
  };
