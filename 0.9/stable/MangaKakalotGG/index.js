...
var source = (() => {
  ...
  // src/MangaKakalotGG/pbconfig.ts
  init_buffer();
  ...
  // src/MangaKakalotGG/main.ts
  var DOMAIN = "https://www.mangakakalot.gg";
  var MangaKakalotGGExtension = class extends MangaboxGeneric {
    constructor() {
      super({
        domain: DOMAIN,
  ...
  var MangaKakalotGG = new MangaKakalotGGExtension();
