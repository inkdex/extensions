...
var source = (() => {
  ...
  // src/MangaBatCOM/main.ts
  var main_exports = {};
  __export(main_exports, {
    MangaBatCOM: () => MangaBatCOM
  });
  init_buffer();
  ...
  // src/MangaBatCOM/main.ts
  var DOMAIN = "https://www.mangabats.com";
  var MangaBatCOMExtension = class extends MangaboxGeneric {
    constructor() {
      super({
        domain: DOMAIN,
  ...
  var MangaBatCOM = new MangaBatCOMExtension();
